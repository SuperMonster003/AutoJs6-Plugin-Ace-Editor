...
* `Функция` Дополнены объявления типов локального плагина ИИ AutoJs6: история сообщений с несколькими ролями, выбор официальных и сторонних плагинов, параметры генерации, точные данные об использовании и потоковой передаче, а также обнаружение моделей через `ai.models`
