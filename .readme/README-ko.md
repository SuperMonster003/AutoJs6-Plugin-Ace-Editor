...
포함된 Gradle Wrapper를 JDK 17 이상 및 Android SDK 37과 함께 사용합니다:
...
* `개선` images.matchTemplate scales 옵션, 템플릿 매치 기하 필드 및 MatchingResult 보조 메서드의 AutoJs6 4.15.0 선언 동기화, 리소스 및 종속성 선언과 LSP 그룹 재생성
