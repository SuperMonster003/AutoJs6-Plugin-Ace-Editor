...
var KotlinHighlightRules = function() {
    ...
    this.$rules = {
        ...
        "#classes": [{
            ...
            push: [{
                ...
                // Ace 1.4.12 marks the declaration keyword as plain text. Keep
                // both captures highlighted so class/object/interface remain
                // visible as Kotlin keywords in the AutoJs6 editor.
                token: ["keyword.other.kotlin", "keyword.other.kotlin"],
    ...
    // The TextMate-derived Kotlin mode does not call createKeywordMapper(), so
    // Ace's built-in keyword completer otherwise receives an empty list.
    this.$keywordList = (
...
(function() {
    ...
    // Upstream 1.4.12 omits this association because its bundled Kotlin
    // snippet file is empty. AutoJs6 ships a maintained Kotlin snippet set.
    this.snippetFileId = "ace/snippets/kotlin";
}).call(Mode.prototype);
