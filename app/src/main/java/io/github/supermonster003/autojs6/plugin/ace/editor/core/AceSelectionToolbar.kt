...
internal class AceSelectionToolbar(
    ...
    data class Labels(
        ...
        val rename: CharSequence,
        val quickFix: CharSequence,
    ...
    private val allItems = mainItems + listOf(
        ...
        Item(labels.rename, AceCodeEditor.SelectionAction.Rename, State::canRename),
        Item(labels.quickFix, AceCodeEditor.SelectionAction.QuickFix, State::canQuickFix),
